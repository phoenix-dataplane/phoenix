...
for concurrency in 32; do
    ...
    for i in 2kb; do
        ...
        fsrv="/tmp/rpc_bench_cpu_monitor_mrpc_rdma_server_tput_${i}${concurrency}c_${timestamp}"
        fcli="/tmp/rpc_bench_cpu_monitor_mrpc_rdma_client_tput_${i}${concurrency}c_${timestamp}"
    ...
    rm -rf ${OD}/benchmark/rpc_bench_tput_rdma_${concurrency}
    mv ${OD}/benchmark/rpc_bench_tput ${OD}/benchmark/rpc_bench_tput_rdma_${concurrency}
done
