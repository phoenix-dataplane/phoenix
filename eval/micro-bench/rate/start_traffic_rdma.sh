...
for i in 1 2 4 8; do
    ...
    fsrv="/tmp/rpc_bench_cpu_monitor_mrpc_rdma_server_rate_${i}t${concurrency}c_${timestamp}"
    fcli="/tmp/rpc_bench_cpu_monitor_mrpc_rdma_client_rate_${i}t${concurrency}c_${timestamp}"
