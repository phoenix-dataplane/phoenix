...
use phoenix_api_policy_mutation::control_plane;
...
pub(crate) struct MutationEngine {
    ...
    pub(crate) config: MutationConfig,
...
impl_vertex_for_engine!(MutationEngine, node);

impl Decompose for MutationEngine {
