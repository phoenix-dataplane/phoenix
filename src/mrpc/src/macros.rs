...
/// ```rust,ignore
/// mod pb {
///     mrpc::include_proto!("helloworld");
/// }
/// ```
///
/// # Note:
/// **This only works if the mrpc-build output directory has been unmodified**.
...
/// the stem of the filename passed to `file_descriptor_set_path` for the `mrpc-build::Builder`,
...
/// ```rust,ignore
/// mod pb {
///     pub(crate) const FILE_DESCRIPTOR_SET: &[u8] = mrpc::include_file_descriptor_set!("my_descriptor");
/// }
/// ```
///
/// # Note:
